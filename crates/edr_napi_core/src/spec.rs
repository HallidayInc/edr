...
use edr_generic::{ArbChainSpec, ArcChainSpec, GenericChainSpec, InjectiveChainSpec};
use edr_provider::{
...
impl<TimerT: Clone + TimeSinceEpoch> SyncNapiSpec<TimerT> for ArcChainSpec {
    const CHAIN_TYPE: &'static str = edr_generic::ARC_CHAIN_TYPE;
